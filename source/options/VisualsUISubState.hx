...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Combo Display',
			'If checked, Display "combo" when the combo is greater than 10.',
			'comboDis',
			'bool');
		addOption(option);

		var option:Option = new Option('MS display',
			'If checked, MS will be displayed.',
			'msDisplay',
			'bool');
		addOption(option);
		...
		var option:Option = new Option('Camera Zooming Mult',
			'Changes the Camera Zoom Multiplicative.',
			'camZoomingMult',
			'float');
