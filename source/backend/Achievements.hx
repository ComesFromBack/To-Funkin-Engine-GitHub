...
class Achievements {
	public static function init()
	{
		...
		createAchievement('strongest', 				{name: "Strongest!!", description: "Complete a Song with a rating higher than 80% and had 9 misses."});
		createAchievement('new_year', 				{name: "Happy New Year!!", description: "Today is New Year! Have funnnnnnnnnnnnnnnnnnnn!!!"});
