...
class ModifierVariables {
    private static final FILE_NAME:String="Modifiers_Variables";
    ...
    public static function saveCurrent(?backup:Bool = false):Void {
		...
		save.bind(FILE_NAME, '${CoolUtil.getSavePath()}/data/Modifiers/');
    ...
    public static function firstModifierSetup():Void {
        ...
        var modMap:Map<String, Array<Dynamic>> = [
            "Single Digits (SDCB)" => [true, 1.5, "You can count the amount of misses on your hand. Miss 10 times and it's over for you.", 2, ClientPrefs.modifier.SingleDigits],
            "Shitty Ending (AFC)" => [true, 5, "Well this will result in a trip to the toilet. Score one shit rating and it's over.", 2, ClientPrefs.modifier.ShittyEnding],
            "Bad Trip (GFC)" => [true, 7, "Locomotion issues. I get it. Score one bad rating and it's over.", 2, ClientPrefs.modifier.BadTrip],
            ...
            "True Perfect (MFC)" => [true, 9, "Good luck. Seriously, you need it. Score one good rating and it's over.", 2, ClientPrefs.modifier.TruePerfect],
            ...
            "Widen Up" => [true, 0, "notes are so funny, hahaha... *sarcasm* How wide notes should be? The higher the wider.", 1, ClientPrefs.modifier.wideNotes, 0, 500, 0.5],
            "Stretch Up" => [true, 0, "Tall notes are so funny, hahaha... *sarcasm* How tall notes should be? The higher the taller.", 1, ClientPrefs.modifier.tallNotes, 0, 400, 0.5],
            ...
            "Invisible Notes" => [true, 0, "Notes are invisible or visible,Reisen is you did?", 2, ClientPrefs.modifier.InvisibleNotes],
            ...
            "Supportive Love" => [true, 0, "Girlfriend loves you very much. How much health do you want to regenerate gradually? The higher, the more love, support and all of that.", 1, ClientPrefs.modifier.Love, 0, 500, 0.5],
            "Poison Fright" => [true, 0, "Please don't be scared. How much health do you want to drain gradually? The higher, the more poison, fear and all of that.", 1, ClientPrefs.modifier.Fright, 0, 500, 0.5],
            ...
            "Drunk Notes" => [true, 0, "Ohhh. What the funk did you drink? Set how much notes should swing up and down. The higher, the more they swing.", 1, ClientPrefs.modifier.DrunkNotes, 0, 400, 0.5],
            "Snake Notes" => [true, 0, "Ayyyy. I guess we're becoming snakes today. Set how much should notes swing left and right. The higher, the more they swing.", 1, ClientPrefs.modifier.SnakeNotes, 0, 400, 0.5],
            "Hyper Notes" => [true, 0, "...How much sugar did you eat? Come on... Give your notes a bit of sugar rush and shake them as much as possible. The higher, the more shaking.", 1, ClientPrefs.modifier.HyperNotes, 0, 400, 0.5],
            "Flipped Notes" => [true, 0, "Oooh no. All around your head. Flip how your notes look. Left is right, up is down.", 2, ClientPrefs.modifier.FlippedNotes],
            "Mirror" => [true, 0, "Mirror your own screen. Fun for everyone.", 2, ClientPrefs.modifier.Mirror],
            "Upside Down" => [true, 0, "Flip everything upside down. Not zero-gravity.", 2, ClientPrefs.modifier.UpsideDown],
            ...
            "Start Health" => [true, 0, "How much slapping did you get before going here? Set how high your health should be at the start. The higher, the higher.", 1, ClientPrefs.modifier.StartHealth, 0, 10, 0.1],
            "Boyfriend Must Die" => [true, 0, "How much ass whoopin do you want? Change how much enemies should damage Boyfriend per note.", 1, ClientPrefs.modifier.mustDie, 0, 500, 0.5],
            ...
            "Accelerating Notes" => [false, 0, "", 1, ClientPrefs.modifier.AccelNotes, 0, 10, 0.5],
            ...
            "Eel Notes" => [false, 0, "", 1, ClientPrefs.modifier.EelNotes, 0, 10, 0.5],
