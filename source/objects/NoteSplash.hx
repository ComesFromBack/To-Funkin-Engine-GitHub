...
class NoteSplash extends FlxSprite
{
	...
	{
		var skin:String = '';
		if(Arrays.noteSplashList[ClientPrefs.data.splashSkin] != Arrays.noteSplashList[ClientPrefs.defaultData.splashSkin])
			skin = '-' + Arrays.noteSplashList[ClientPrefs.data.splashSkin].trim().toLowerCase().replace(' ', '-');
		return skin;
	}
