...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt = new FlxText(0, 0, FlxG.width, "SEARCHING FOR MOD ARCHIVES...", 48);
		...
		installButton = new FlxButton(startX, 620, "Reload All Mod", function()
		{
			var fileStr:String = '';
